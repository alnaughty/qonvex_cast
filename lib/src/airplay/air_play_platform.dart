...
import 'package:qonvex_cast/src/airplay/air_play_event.dart';
import 'package:qonvex_cast/src/airplay/method_channel_air_play.dart';

/// The interface that platform-specific implementations of `flutter_video_cast` must extend.
abstract class AirPlayPlatform {
  static MethodChannelAirPlay _instance = MethodChannelAirPlay();
